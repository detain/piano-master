...
## 0. Record meta
- song_id:        `sonatina-op36-1-l3`
- title (canonical): Sonatina in C major, Op. 36 No. 1 (from 6 Piano Sonatinas, Op. 36)
...
## 1. Identify the work
- Composer / attribution:            Muzio Clementi
- Catalogue no. (BWV / K. / WoO / Op. / P. / H.): Op. 36 No. 1 (from 6 Piano Sonatinas, Op. 36)
- Composition year: 1797
- Source for composition year:       candidates-2026-08.md row 11 ("1797 / **1797** Longman & Broderip"); IMSLP work page "6 Piano Sonatinas, Op.36"

## 2. Composer death year → EU life+70 check
- Composer death year:               1832 (source: candidates-2026-08.md row 11, P0.8 research 2026-08-22, verified against the IMSLP work page)
- EU PD date: 1 Jan (death_year + 71) =  1903  →  PD in EU: [x] yes (if ≤ current year) [ ] no → FLAG
...
- France war-extension check (French composers / works first published in France):
    - n/a — Italian composer; first edition published by Longman & Broderip (London), not in France.
...
- If multiple authors (composer + librettist): use the LAST survivor's death year (EU joint-work rule).
    - n/a — instrumental piano sonatina, no librettist.

## 3. First publication → USA rule
- First publication year:            1797 — first edition, Longman & Broderip, London
- First publication source (IMSLP "First Publication" field / publisher archive / WorldCat): IMSLP work page "First Publication" field; candidates-2026-08.md row 11
...
- Posthumous publication nuance: first publication year may differ from composition year — record BOTH.
    - Composition 1797, first publication 1797 — within the composer's lifetime (d. 1832); no posthumous nuance.

## 4. Edition provenance (the edition trap, §8.5.3)
- Source type:  [x] IMSLP scan   [ ] Mutopia typeset   [ ] other (archive.org / library scan)
- Work page URL: https://imslp.org/wiki/6_Piano_Sonatinas,_Op.36_(Clementi,_Muzio)
- **File/scan URL** (specific file page or PDF URL): TO CONFIRM at ingest — Clementi's own 5th/6th editions (composer-fingered, PD-tagged) on the work page, per candidates row 11
...
- Edition:  publisher, year, plate no.: Clementi's own 5th/6th editions (composer-fingered) — publisher/year/plate TO CONFIRM at ingest; first edition 1797, Longman & Broderip, London
- Editor (if any) + editor death year:     n/a — the composer's own editions (5th/6th eds.), fingered by Clementi himself (candidates row 11)
...
- Is this a modern *arrangement* by a living/recent arranger?  [x] no [ ] yes → REJECT as source (reference only)
    - Avoid copying 20th-century graded-edition fingerings (e.g., Schirmer) — we add our own (candidates row 11).
...
- For each: rule applied and result (life+70 / pre-1931 / longer terms: ES 80, MX 100, CO 80…).
    - US: first publication 1797 ≤ 1930 → pre-1931 rule → PD
    - EU (DE, FR, ES…): life+70 → PD since 1 Jan 1903; Spain 80-year → PD since 1913
    - UK / CA / AU: life+70 → PD
    - JP: life+70 → PD
    - BR: life+70 → PD; IN: life+60 → PD (all clear by death-year arithmetic, d. 1832)
- Any jurisdiction still restricted?  [x] none   [ ] list + geo-gate decision:
- territory_flags_json (per §8.5.6 schema):
  ```json
  {
    "US":  {"rule": "first publication <= 1930 (1797 Longman & Broderip)", "pd": true},
    "EU":  {"rule": "life+70 (d. 1832)", "pd": true, "note": "PD from 1 Jan 1903; ES 80-year clear 1913"},
...
- Any elements copied from a modern arrangement?  [x] none (required)
    - Do-not-copy: 20th-century graded-edition fingerings (e.g., Schirmer) — we add our own (candidates row 11).
...
## 7. Verdict
- [x] GLOBALLY PD        (rule that establishes it: Clementi d. 1832; pub. 1797 → USA pre-1931)
