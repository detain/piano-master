...
## 0. Record meta
- song_id:        `canon-in-d-l2`
- title (canonical): Canon in D major (Canon and Gigue in D major, P. 37)
...
## 1. Identify the work
- Composer / attribution:            Johann Pachelbel
- Catalogue no. (BWV / K. / WoO / Op. / P. / H.): P. 37 (Canon and Gigue in D major)
- Composition year: c. 1680
- Source for composition year:       candidates-2026-08.md row 6 ("c. 1680 / first modern pub. **1919** (Kistner & Siegel, ed. Beckmann)"); IMSLP work page "Canon and Gigue in D major, P.37"

## 2. Composer death year → EU life+70 check
- Composer death year:               1706 (source: candidates-2026-08.md row 6, P0.8 research 2026-08-22, verified against the IMSLP work page)
- EU PD date: 1 Jan (death_year + 71) =  1777  →  PD in EU: [x] yes (if ≤ current year) [ ] no → FLAG
...
- France war-extension check (French composers / works first published in France):
    - n/a — German composer; first modern edition published by Kistner & Siegel, not in France.
...
- If multiple authors (composer + librettist): use the LAST survivor's death year (EU joint-work rule).
    - n/a — instrumental work (3 violins + continuo), no librettist.

## 3. First publication → USA rule
- First publication year:            1919 — first modern publication (posthumous), Kistner & Siegel, ed. Beckmann (composition c. 1680, manuscript era; no contemporary publication recorded)
- First publication source (IMSLP "First Publication" field / publisher archive / WorldCat): candidates-2026-08.md row 6; IMSLP work page
...
- Posthumous publication nuance: first publication year may differ from composition year — record BOTH.
    - Composition c. 1680, first modern publication 1919 — posthumous first publication, recorded (the §8.5.1 step-3 edge case; 1919 ≤ 1930, so no USA issue).

## 4. Edition provenance (the edition trap, §8.5.3)
- Source type:  [x] IMSLP scan   [ ] Mutopia typeset   [ ] other (archive.org / library scan)
- Work page URL: https://imslp.org/wiki/Canon_and_Gigue_in_D_major,_P.37_(Pachelbel,_Johann)
- **File/scan URL** (specific file page or PDF URL): TO CONFIRM at ingest — any PD-tagged scan of the 1919 Kistner & Siegel first modern edition on the work page
...
- Edition:  publisher, year, plate no.: 1919, Kistner & Siegel, ed. Beckmann (first modern edition) — city/plate TO CONFIRM at ingest
- Editor (if any) + editor death year:     ed. Beckmann (first name TO CONFIRM at ingest) — death year TO CONFIRM at ingest; edition published 1919 ≤ 1930 → PD in USA
...
- Is this a modern *arrangement* by a living/recent arranger?  [x] no [ ] yes → REJECT as source (reference only)
    - The original is 3 violins + continuo — our piano arrangement is inherently a new arrangement of a PD work (fine, candidates row 6).
...
- For each: rule applied and result (life+70 / pre-1931 / longer terms: ES 80, MX 100, CO 80…).
    - US: first publication 1919 ≤ 1930 → pre-1931 rule → PD
    - EU (DE, FR, ES…): life+70 → PD since 1 Jan 1777; Spain 80-year → PD since 1787
    - UK / CA / AU: life+70 → PD
    - JP: life+70 → PD
    - BR: life+70 → PD; IN: life+60 → PD (all clear by death-year arithmetic, d. 1706)
- Any jurisdiction still restricted?  [x] none   [ ] list + geo-gate decision:
- territory_flags_json (per §8.5.6 schema):
  ```json
  {
    "US":  {"rule": "first publication <= 1930 (1919 Kistner & Siegel)", "pd": true},
    "EU":  {"rule": "life+70 (d. 1706)", "pd": true, "note": "PD from 1 Jan 1777; ES 80-year clear 1787"},
...
- Any elements copied from a modern arrangement?  [x] none (required)
    - Do-not-copy: George Winston's 1982 arrangement is copyrighted (candidates row 6) — reference only, never copied.
...
## 7. Verdict
- [x] GLOBALLY PD        (rule that establishes it: Pachelbel d. 1706; first modern pub. 1919 → USA pre-1931)
