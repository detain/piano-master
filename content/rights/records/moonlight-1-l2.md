...
## 0. Record meta
- song_id:        `moonlight-1-l2`
- title (canonical): Piano Sonata No. 14 in C-sharp minor, Op. 27 No. 2, movement I ("Moonlight" — Rellstab nickname, metadata only)
...
- Catalogue no. (BWV / K. / WoO / Op. / P. / H.): Op. 27 No. 2 (Piano Sonata No. 14), movement I
- Composition year: 1801
- Source for composition year:       candidates-2026-08.md row 9 ("1801 / **1802**"); IMSLP work page "Piano Sonata No.14, Op.27 No.2"
    - Note: the famous "Moonlight" nickname (Rellstab) is metadata only (candidates row 9).

## 2. Composer death year → EU life+70 check
- Composer death year:               1827 (source: candidates-2026-08.md row 9, P0.8 research 2026-08-22, verified against the IMSLP work page)
...
- First publication year:            1802 — first edition (publisher/city TO CONFIRM at ingest)
- First publication source (IMSLP "First Publication" field / publisher archive / WorldCat): IMSLP work page "First Publication" field; candidates-2026-08.md row 9
...
- Posthumous publication nuance: first publication year may differ from composition year — record BOTH.
    - Composition 1801, first publication 1802 — within the composer's lifetime (d. 1827); no posthumous nuance.

## 4. Edition provenance (the edition trap, §8.5.3)
- Source type:  [x] IMSLP scan   [ ] Mutopia typeset   [ ] other (archive.org / library scan)
- Work page URL: https://imslp.org/wiki/Piano_Sonata_No.14,_Op.27_No.2_(Beethoven,_Ludwig_van)
- **File/scan URL** (specific file page or PDF URL): TO CONFIRM at ingest — first-edition (1802) scans (PD-tagged, per candidates row 9) on the work page
...
- Edition:  publisher, year, plate no.: 1802, first edition — publisher/city/plate TO CONFIRM at ingest
...
- For each: rule applied and result (life+70 / pre-1931 / longer terms: ES 80, MX 100, CO 80…).
    - US: first publication 1802 ≤ 1930 → pre-1931 rule → PD
...
- territory_flags_json (per §8.5.6 schema):
  ```json
  {
    "US":  {"rule": "first publication <= 1930 (1802)", "pd": true},
...
- Any elements copied from a modern arrangement?  [x] none (required)
    - None identified in the candidates research (row 9).
...
## 7. Verdict
- [x] GLOBALLY PD        (rule that establishes it: Beethoven d. 1827; pub. 1802 → USA pre-1931)
