...
## 0. Record meta
- song_id:        `fur-elise-l2`
- title (canonical): Für Elise
...
- Catalogue no. (BWV / K. / WoO / Op. / P. / H.): WoO 59
- Composition year: 1810
- Source for composition year:       candidates-2026-08.md row 2 ("1810 / **1867** (posth., Nohl)"); IMSLP work page "Für Elise, WoO 59" (dated autograph)

## 2. Composer death year → EU life+70 check
- Composer death year:               1827 (source: candidates-2026-08.md row 2, P0.8 research 2026-08-22, verified against the IMSLP work page)
...
- France war-extension check (French composers / works first published in France):
    - n/a — German composer; no France publication indicated in the research.
...
- First publication year:            1867 — posthumous first edition, ed. Ludwig Nohl (publisher/city TO CONFIRM at ingest)
- First publication source (IMSLP "First Publication" field / publisher archive / WorldCat): IMSLP work page "First Publication" field; candidates-2026-08.md row 2
...
- Posthumous publication nuance: first publication year may differ from composition year — record BOTH.
    - Composition 1810, first publication 1867 (posthumous, 40 years after the composer's death, 57 years after composition) — exactly the §8.5.1 step-3 edge case; recorded.

## 4. Edition provenance (the edition trap, §8.5.3)
- Source type:  [x] IMSLP scan   [ ] Mutopia typeset   [ ] other (archive.org / library scan)
- Work page URL: https://imslp.org/wiki/F%C3%BCr_Elise,_WoO_59_(Beethoven,_Ludwig_van)
- **File/scan URL** (specific file page or PDF URL): TO CONFIRM at ingest — 1867 Nohl first-edition scan (PD-tagged) on the work page
...
- Edition:  publisher, year, plate no.: 1867 first edition (posthumous), ed. Ludwig Nohl — publisher/city/plate TO CONFIRM at ingest
- Editor (if any) + editor death year:     Ludwig Nohl, d. 1885 → PD in EU (1885 + 71 = 1956); edition published 1867 ≤ 1930 → PD in USA
...
- Is this a modern *arrangement* by a living/recent arranger?  [x] no [ ] yes → REJECT as source (reference only)
    - Avoid copying modern editorial fingerings (we add our own) — candidates row 2.
...
- For each: rule applied and result (life+70 / pre-1931 / longer terms: ES 80, MX 100, CO 80…).
    - US: first publication 1867 ≤ 1930 → pre-1931 rule → PD
...
- territory_flags_json (per §8.5.6 schema):
  ```json
  {
    "US":  {"rule": "first publication <= 1930 (1867 posthumous)", "pd": true},
...
- Any elements copied from a modern arrangement?  [x] none (required)
    - Do-not-copy: modern editorial fingerings (candidates row 2) — we add our own.
...
## 7. Verdict
- [x] GLOBALLY PD        (rule that establishes it: Beethoven d. 1827; first pub. 1867 (posthumous, Nohl) → USA pre-1931)
